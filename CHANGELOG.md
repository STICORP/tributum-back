...
- Integration test suite with Docker-based fixtures and end-to-end testing capabilities
...
- Thread safety issue in database session factory initialization
...
- Comprehensive unit tests for request logging middleware with concurrent request isolation
...
- Automatic HTTP client instrumentation for HTTPX and Requests libraries
...
[Unreleased]: https://github.com/STICORP/tributum-back/compare/v0.4.0...HEAD
[0.4.0]: https://github.com/STICORP/tributum-back/compare/v0.3.0...v0.4.0
