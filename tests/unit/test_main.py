...
@pytest.mark.unit
def test_main_function_runs_uvicorn_in_debug_mode(mocker: MockerFixture) -> None:
...
@pytest.mark.unit
def test_main_function_runs_uvicorn_in_production_mode(mocker: MockerFixture) -> None:
